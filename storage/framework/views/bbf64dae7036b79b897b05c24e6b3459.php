              ...
              <div class="row">
                <div class="col-xl-12 col-lg-12 col-md-12 mt-3">
                    <form method="POST" action="/createaccount">
                        ...
                        <input type="hidden" name="id" class="form-control rounded-0" value="<?php echo e($account->id ?? ''); ?>">
...
<?php /**PATH C:\xampp\htdocs\churchmanagementsystem\resources\views/createaccount.blade.php ENDPATH**/ ?>